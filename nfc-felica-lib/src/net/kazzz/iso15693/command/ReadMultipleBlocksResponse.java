...
import static net.kazzz.iso15693.lib.ISO15693Lib.Flags.ERROR_DETECT_ERROR;
...
public class ReadMultipleBlocksResponse extends ReadSingleBlockResponse {
    ...
    public static class BlockData implements Parcelable, IISO15693ByteData {
        ...
        /* (non-Javadoc)
         * @see net.kazzz.iso15693.IISO15693ByteData#getBytes()
         */
        @Override
        ...
        public String toString() {
            ...
            sb.append("　データ: " + new String(mData, Charset.defaultCharset()) 
                    + "(" + Util.getHexString(mData) + ")"  + "\n");
            return sb.toString();
        }
   }
    ...
    /* (non-Javadoc)
     * @see net.felica.IISO15693ByteData#getBytes()
     */
    @Override
    public byte[] getBytes() {
        int length = 0;
    ...
    /**
     * blockDatasを取得します
     * @return BlockData[] blockDatasが戻ります
     */
    ...
    public String toString() {
        ...
        for ( int i = 0; i < mBlockDatas.length; i++ ) {
